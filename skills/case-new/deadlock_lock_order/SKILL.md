...
-- 转账：A001 → B002
BEGIN;
UPDATE <target_table> SET balance = balance - 1000 WHERE account_id = 'A001'; -- 先锁小
UPDATE <target_table> SET balance = balance + 1000 WHERE account_id = 'B002'; -- 后锁大
...
BEGIN;
UPDATE <target_table> SET balance = balance + 500 WHERE account_id = 'A001'; -- 先锁小
UPDATE <target_table> SET balance = balance - 500 WHERE account_id = 'B002'; -- 后锁大
INSERT INTO <target_table> (<filter_col>, <groupby_col>, <join_col>, <order_col>, <col_5>)
...
-- 检查余额
-- 执行转账更新
UPDATE <target_table> SET balance = balance - 1000 WHERE account_id = 'A001';
UPDATE <target_table> SET balance = balance + 1000 WHERE account_id = 'B002';
INSERT INTO <target_table> (<filter_col>, <groupby_col>, <join_col>, <order_col>, <col_5>)
VALUES ('A001', 'B002', 1000, CURRENT_TIMESTAMP, 'SUCCESS');
COMMIT;
```
