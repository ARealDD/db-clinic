...
-- 为每个分区创建复合索引
CREATE INDEX idx_tx_202301_cust_date ON transactions_202301(customer_id, transaction_date);
CREATE INDEX idx_tx_202302_cust_date ON transactions_202302(customer_id, transaction_date);
-- ... 依此类推
```
